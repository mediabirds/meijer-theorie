...
<Box class="text-center">
	<div class="mx-auto flex max-w-xl flex-col items-center justify-center gap-6">
		<H level="4">{$_('pages.practice_exams.results.failed_title')}</H>
...
<Box>
	<H level="4" class="mb-2">{$_('pages.practice_exams.results.failed_try_again')}</H>
	<span class="block max-w-3xl">
		{$_('pages.practice_exams.results.failed_try_again_description')}
	</span>
